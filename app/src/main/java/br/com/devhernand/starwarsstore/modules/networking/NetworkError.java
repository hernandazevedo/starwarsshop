...
public class NetworkError extends Throwable {
    public static final String DEFAULT_ERROR_MESSAGE = "Algo de errado aconteceu. Tente novamente";
    public static final String NETWORK_ERROR_MESSAGE = "Sem conexão com a internet!";
